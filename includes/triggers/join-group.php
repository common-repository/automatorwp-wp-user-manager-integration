...
class AutomatorWP_WP_User_Manager_Join_Group extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User joins a group', 'automatorwp-wp-user-manager-integration' ),
            'select_option'     => __( 'User <strong>joins</strong> a group', 'automatorwp-wp-user-manager-integration' ),
            /* translators: %1$s: Group. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User joins %1$s %2$s time(s)', 'automatorwp-wp-user-manager-integration' ), '{post}', '{times}' ),
            /* translators: %1$s: Group. */
            'log_label'         => sprintf( __( 'User joins %1$s', 'automatorwp-wp-user-manager-integration' ), '{post}' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    ...
                    'option_none_label' => __( 'any group', 'automatorwp-wp-user-manager-integration' ),
