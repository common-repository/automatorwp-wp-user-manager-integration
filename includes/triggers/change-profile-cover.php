...
class AutomatorWP_WP_User_Manager_Change_Profile_Cover extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User changes profile cover', 'automatorwp-wp-user-manager-integration' ),
            'select_option'     => __( 'User changes <strong>profile cover</strong>', 'automatorwp-wp-user-manager-integration' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User changes profile cover %1$s time(s)', 'automatorwp-wp-user-manager-integration' ), '{times}' ),
            'log_label'         => __( 'User changes profile cover', 'automatorwp-wp-user-manager-integration' ),
