...
class AutomatorWP_WP_User_Manager_User_Register extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User registers through a form', 'automatorwp-wp-user-manager-integration' ),
            'select_option'     => __( 'User <strong>registers</strong> through a form', 'automatorwp-wp-user-manager-integration' ),
            /* translators: %1$s: Form. */
            'edit_label'        => sprintf( __( 'User registers through %1$s', 'automatorwp-wp-user-manager-integration' ), '{form}' ),
            'log_label'         => sprintf( __( 'User registers through %1$s', 'automatorwp-wp-user-manager-integration' ), '{form}' ),
            ...
            'options'           => array(
                'form' => automatorwp_utilities_ajax_selector_option( array(
                    'field'             => 'form',
                    'name'              => __( 'Form:', 'automatorwp-wp-user-manager-integration' ),
                    'option_none_value' => 'any',
                    'option_none_label' => __( 'any form', 'automatorwp-wp-user-manager-integration' ),
