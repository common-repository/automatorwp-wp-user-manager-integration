...
class AutomatorWP_WP_User_Manager_User_Login extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User logs in to the site', 'automatorwp-wp-user-manager-integration' ),
            'select_option'     => __( 'User <strong>logs in</strong> to the site', 'automatorwp-wp-user-manager-integration' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User logs in %1$s time(s)', 'automatorwp-wp-user-manager-integration' ), '{times}' ),
            'log_label'         => __( 'User logs in', 'automatorwp-wp-user-manager-integration' ),
